...
//
//********************************************************************************************
extern TcpConnection connections[TCP_MAX_CONNECTIONS];
void TcpInit();
...
extern unsigned char (* TCP_ON_NEW_CONNETION_CALLBACK)(const unsigned char connectionId);
extern void (* TCP_ON_CONNECT_CALLBACK)(const unsigned char connectionId);
extern void (* TCP_ON_INCOMING_DATA_CALLBACK)(const unsigned char connectionId, const unsigned char *data, unsigned short dataLength);
extern void (* TCP_ON_DISCONNECT_CALLBACK)(const unsigned char connectionId);
#endif
