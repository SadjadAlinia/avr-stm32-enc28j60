...
void HttpInit(){
	...
	TCP_ON_NEW_CONNETION_CALLBACK = &HttpTcpOnNewConnection;
	TCP_ON_CONNECT_CALLBACK = &HttpTcpOnConnect;
	TCP_ON_INCOMING_DATA_CALLBACK = &HttpTcpOnIncomingData;
	TCP_ON_DISCONNECT_CALLBACK = &HttpTcpOnDisconnect;
}
